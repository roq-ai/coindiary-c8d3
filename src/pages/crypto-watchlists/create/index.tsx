...
import { createCryptoWatchlist } from 'apiSdk/crypto-watchlists';
...
function CryptoWatchlistCreatePage() {
  ...
  const handleSubmit = async (values: CryptoWatchlistInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createCryptoWatchlist(values);
      resetForm();

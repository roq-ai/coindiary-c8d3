...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`coindiary`}</title>

        <meta
          name="description"
          content="Welcome to coindiary, your one-stop solution for crypto-related news. Stay updated, stay ahead, and navigate the crypto world with confidence."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1518546305927-5a555bb7020d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcnlwdG9jdXJyZW5jeXxlbnwwfHx8fDE2OTU2NDA5ODB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to coindiary, your one-stop solution for crypto-related news. Stay updated, stay ahead, and navigate the crypto world with confidence.`}
            </Text>
            <Box

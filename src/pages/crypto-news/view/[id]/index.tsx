...
import { getCryptoNewsById } from 'apiSdk/crypto-news';
import { CryptoNewsInterface } from 'interfaces/crypto-news';

function CryptoNewsViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('crypto_news', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/crypto-news/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Published At"
                  text={
                    data?.published_at ? format(parseISO(data?.published_at as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />

                <FormListItem label="Source" text={data?.source} />

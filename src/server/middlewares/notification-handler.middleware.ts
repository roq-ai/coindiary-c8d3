...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['owner', 'admin'], key: 'order', tenantPath: [], userPath: [] },
  'pricing_updated.update': { roles: ['owner', 'admin'], key: 'pricing', tenantPath: [], userPath: [] },
  'product_added.create': { roles: ['owner', 'admin'], key: 'product', tenantPath: [], userPath: [] },
};
